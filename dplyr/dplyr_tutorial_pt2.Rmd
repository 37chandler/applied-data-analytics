---
layout: page
title: dplyr Introduction - Part 2
---
...
our DB instead of our text files. Here we'll have to specify the 
full path, so please modify the first line of code below to take us
to the DB. There's a lot of 
documentation [here](https://db.rstudio.com/dplyr/). 

```{r}
path.to.db <- paste0("C:\\Users\\jchan\\Dropbox\\",
                     "Teaching\\AppliedDataAnalytics\\",
                     "applied-data-analytics\\dplyr\\")
